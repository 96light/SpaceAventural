...
void GSSetting2::Exit()
{
}


void GSSetting2::Pause()
{

}

void GSSetting2::Resume()
{

}


void GSSetting2::HandleEvents()
{

}

void GSSetting2::HandleKeyEvents(int key, bool bIsPressed)
{

}

void GSSetting2::HandleTouchEvents(int x, int y, bool bIsPressed)
{
...
void GSSetting2::HandleMouseEvents(int x, int y)
{
}

void GSSetting2::Update(float deltaTime)
{
